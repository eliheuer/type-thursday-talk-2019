...
text("", M+2, M-2+(G*6))
fill(1)
text("Education:", M+2, M-2+(G*5))
fill(0.9, 0.4, 0.3)
text("", M+2, M-2+(G*4))
fill(0.9, 0.3, 0.3)
text("Good for students", M+2, M-2+(G*3))
fill(0.9, 0.2, 0.3)
text("Free for everyone", M+2, M-2+(G*2))
fill(0.9, 0.1, 0.3)
text("Used at Type@Cooper?", M+2, M-2+(G*1))
fill(0.9, 0, 0.3)
text("", M+2, M-2+(G*0))
...
fill(0.9, 0.3, 0.3)
#text("Read aloud", v_edge, M-2+(G*3))
fill(0.9, 0.2, 0.3)
#text("Ignored", v_edge, M-2+(G*2))
fill(0.9, 0.1, 0.3)
#text("Integrated into a toaster", v_edge, M-2+(G*1))
fill(0.9, 0, 0.3)
...
v_edge = M+2+(G*27)
fill(1)
text("“How can you", v_edge-10, M-2+(G*9))
text("own numbers?", v_edge, M-2+(G*8))
text("Numbers belong", v_edge, M-2+(G*7))
text("to the world.”", v_edge, M-2+(G*6))
text("—Donald Knuth", v_edge, M-2+(G*4))
